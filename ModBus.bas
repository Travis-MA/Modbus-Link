...
Private Function runCRC(ByVal a, b, c, d, e, f As Byte) As String
    ReDim buf(7) As Byte
...
Public Function GenerateReq(ByVal SlaveID, Addr As String) As String


    On Error GoTo Err_Handle
        a = Split(Addr, "-")
        Dim resp As String
        resp = runCRC(SlaveID, "03", a(0), a(1), "00", "01")
        GenerateReq = resp
